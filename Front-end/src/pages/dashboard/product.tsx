...
const ProductComponent = () => {
    ...
    const validateForm = () => {
        ...
        if ((editProduct ? editProduct.purchasePrice : newProduct.purchasePrice) <= 0)
        ...
        <PageContainer>
                                ...
                                {filteredProducts?.map((product) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <ResponsiveTableCell>{product.description} </ResponsiveTableCell>

                                            <ResponsiveTableCell>{product.purchasePrice} DT</ResponsiveTableCell>
                                            <ResponsiveTableCell>{product.sellingPrice} DT</ResponsiveTableCell>
            ...
            >
                ...
                <TextField
                    ...
                    fullWidth
                    type="number"
                    value={editProduct ? editProduct.purchasePrice : newProduct.purchasePrice}
                    onChange={(e) => {
                ...
                <TextField
                    ...
                    fullWidth
                    type="number"
                    value={editProduct ? editProduct.sellingPrice : newProduct.sellingPrice}
                    onChange={(e) => {
                        const value = Math.max(0, +e.target.value);
                        editProduct
                ...
                >
                    ...
                    <SubmitButton onClick={editProduct ? handleUpdateProduct : handleAddProduct}>
