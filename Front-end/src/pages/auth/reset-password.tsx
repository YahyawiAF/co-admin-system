...
function ResetPassword() {
  ...
  const [verifyCode, { isLoading: isVerifying, error: verifyError }] =
    useVerifyResetCodeMutation();

  const [
    resetPassword,
    { isLoading: isResetting, isSuccess, error: resetError },
  ] = useResetPasswordMutation();

  const [resetPasswordWithPhone, { isLoading: isResettingPhone }] =
    useResetPasswordWithPhoneMutation();
